...
*   **Embedded Loops:**
    *   [LOOP-001: Architecture Discovery](../loops/core/LOOP-001-Architecture-Discovery.md) - Automatically maps the directory structure, dependencies, and files.
    *   [LOOP-002: Context Assembly](../loops/core/LOOP-002-Context-Assembly.md) - Grabs relevant files for execution context.
...
*   **Embedded Loops:**
    *   [LOOP-004: Planning](../loops/core/LOOP-004-Planning.md) - Outlines files and changes.
    *   [LOOP-005: Implementation](../loops/core/LOOP-005-Implementation.md) - Restricts code generation to only the files outlined in the plan.
...
*   **Embedded Loops:**
    *   [LOOP-101: Bug Fixing](../loops/engineering/LOOP-101-Bug-Fixing.md) - Guides the full lifecycle of bug resolution.
    *   [LOOP-103: Test Generation](../loops/engineering/LOOP-103-Test-Generation.md) - Generates the reproduction test harness.
...
*   **Embedded Loops:**
    *   [LOOP-102: Refactoring](../loops/engineering/LOOP-102-Refactoring.md) - Simplifies structure without changing functional behavior.
    *   [LOOP-204: API Contract Validation](../loops/platform/LOOP-204-API-Contract-Validation.md) - Enforces compliance with REST/gRPC specifications.
...
*   **Embedded Loops:**
    *   [LOOP-105: Code Review](../loops/engineering/LOOP-105-Code-Review.md) - Automated verification by an independent review agent.
...
*   **Embedded Loops:**
    *   [LOOP-101: Bug Fixing](../loops/engineering/LOOP-101-Bug-Fixing.md) - Resolving the defect.
    *   [LOOP-304: Release Readiness](../loops/governance/LOOP-304-Release-Readiness.md) - Verifies the patch passes checkstyle, unit testing, and is signed off.
...
*   **Embedded Loops:**
    *   [LOOP-007: Reflection](../loops/core/LOOP-007-Reflection.md) - Collects telemetry and updates memory.
...
*   **Embedded Loops:**
    *   [LOOP-301: ADR Generation](../loops/governance/LOOP-301-ADR-Generation.md) - Enforces architectural alignment.
    *   [LOOP-302: Doc Governance](../loops/governance/LOOP-302-Doc-Governance.md) - Scans for broken links and outdated guidelines.
